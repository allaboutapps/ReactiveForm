...
public enum FormItemType: Decodable, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        guard let value = FormItemType(rawValue: rawValue) else {
    ...
    public static func ==(lhs: FormItemType, rhs: FormItemType) -> Bool {
